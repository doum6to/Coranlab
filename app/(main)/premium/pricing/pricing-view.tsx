...
export const PricingView = () => {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-12">
        {/* Logo mark */}
        ...
        {/* Title */}
        <h1 className="text-center text-2xl sm:text-5xl font-extrabold text-brilliant-text leading-tight font-heading mb-3 px-2">
          Débloque toute l&apos;expérience Quranlab
        </h1>
        <p className="text-center text-brilliant-muted text-sm sm:text-lg mb-10 sm:mb-14 px-2">
          Premium te donne un accès complet à tous les cours — et bien plus.
        </p>

        {/* Plans */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6 max-w-2xl mx-auto pt-4">
          {/* Monthly */}
          <button
            type="button"
            onClick={() => setSelected("monthly")}
            aria-pressed={selected === "monthly"}
            className="relative w-full rounded-2xl p-[3px] text-left transition hover:scale-[1.01] cursor-pointer"
            style={{
              background:
                selected === "monthly"
                  ? "linear-gradient(135deg, #F7C325 0%, #E350E3 35%, #874DE5 65%, #456DFF 100%)"
          ...
          >
            <div className="rounded-[14px] bg-white p-6">
              <div className="flex items-center justify-between mb-2">
                <div className="text-lg sm:text-xl font-bold text-brilliant-text">
                  Mensuel
                </div>
                <div
                ...
                >
                  {selected === "monthly" && (
                    <div className="w-2.5 h-2.5 rounded-full bg-brilliant-text" />
                  )}
                </div>
              </div>
          ...
          <div className="relative">
            ...
            <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-10">
              <div
                className="rounded-full text-[10px] sm:text-xs font-extrabold tracking-widest uppercase whitespace-nowrap"
                style={{
                  background:
        ...
        <div className="flex justify-center mt-10 sm:mt-14">
          <button
            onClick={onSubscribe}
            disabled={pending}
            className="rounded-full px-10 sm:px-16 py-4 text-white text-base sm:text-lg font-bold transition hover:opacity-90 hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60"
            style={{
              background: "#0F172A",
