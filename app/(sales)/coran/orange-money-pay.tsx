...
/**
 * Inline Orange Money form (Option A, manual): the buyer pays the merchant
 * number, then submits their email + the OM transaction id. Shown when the
 * "Orange Money" method is selected in <PaymentMethods>.
 */
export function OrangeMoneyForm({ om }: { om: CoranOrangeMoney }) {
