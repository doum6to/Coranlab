...
import { StickyPayBar } from "../coran/sticky-pay-bar";
import { DuasPaymentMethods } from "./payment-methods";
...
export function DuasLanding({ content }: { content: DuasLandingContent }) {
  const c = content;
      ...
      <div className="mx-auto max-w-[560px] px-4 pb-28 pt-4">
        ...
        <div className="mt-10">
          ...
          <div className="rounded-2xl border border-neutral-200 bg-white p-4 text-neutral-900 shadow-sm">
            ...
            <DuasPaymentMethods omEnabled={c.orangeMoney.enabled} om={c.orangeMoney} />
          </div>
          {c.guarantee && (
