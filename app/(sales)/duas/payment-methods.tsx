...
import { DuasCheckoutEmbed } from "./checkout-embed";
import { DuasOrangeMoneyForm } from "./orange-money-pay";
...
/** Payment-method selector for the /duas checkout box (card or Orange Money). */
export function DuasPaymentMethods({
  omEnabled,
  om,
}: {
  omEnabled: boolean;
  ...
  if (!omEnabled) return <DuasCheckoutEmbed />;
  ...
  return (
    <div className="space-y-3">
      ...
      {method === "om" && <DuasOrangeMoneyForm om={om} />}
    </div>
  );
}
