...
export async function updateSession(request: NextRequest) {
  ...
  const publicRoutes = ["/", "/api/webhooks/stripe", "/api/webhooks/revenuecat", "/api/auth/signup", "/api/course/activate", "/auth/login", "/auth/signup", "/auth/callback", "/auth/forgot-password", "/auth/reset-password", "/onboarding", "/carrousel"];
  const isPublicRoute =
